...
#define STRING_CONFIG_H_AUTHOR "(Eric H CenturionAD, Tevo Tarantula Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tarantula Pro by Centurion-Configurations"
